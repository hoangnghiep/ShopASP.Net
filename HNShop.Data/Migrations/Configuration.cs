namespace HNShop.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<HNShop.Data.HNShopDbContext>
    {
        ...
        private void CreateUser(HNShopDbContext context)
        {
        ...
        private void CreateFooter(HNShopDbContext context)
        {
        ...
        private void CreateSlide(HNShopDbContext context)
        {
        ...
        private void CreatePage(HNShopDbContext context)
        {
        ...
        private void CreateContactDetail(HNShopDbContext context)
        {
            if (context.ContactDetails.Count() == 0)
            {
                try
                {
                    var contactDetail = new HNShop.Model.Models.ContactDetail()
                    {
                        Name = "Shop thời trang HoangNghiep",
                        Address = "Ngõ 77 Xuân La",
                        Email = "hoangnghiep169@gmail.com",
                        Lat = 21.0633645,
                        Lng = 105.8053274,
                        Phone = "095423233",
                        Website = "http://hoangnghiep.com.vn",
                        Other = "",
                        Status = true
                    };
