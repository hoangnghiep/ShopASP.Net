...
using HNShop.Web.Infrastructure.Core;
...
[assembly: OwinStartup(typeof(HNShop.Web.App_Start.Startup))]

namespace HNShop.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(HNShopDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<HNShopDbContext>());
